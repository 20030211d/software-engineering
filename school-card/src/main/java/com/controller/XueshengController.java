...
public class XueshengController {
    ...
    public R register(@RequestBody XueshengEntity xuesheng, @RequestParam(required = false) String emailcode){
		...
		//校验邮箱验证码
		user =xueshengService.selectOne(new EntityWrapper<XueshengEntity>().eq("email", xuesheng.getEmail()));
		if(user!=null) {
		...
		List<EmailregistercodeEntity> emailregistercodeList = emailregistercodeService.selectList(
										...
										.eq("email", xuesheng.getEmail()).orderBy("addtime", false));
