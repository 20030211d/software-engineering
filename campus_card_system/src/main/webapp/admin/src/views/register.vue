  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="邮箱" class="input send-code" v-if="tableName=='xuesheng'">
			...
			<el-form-item label="验证码" class="input" v-if="tableName=='xuesheng'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`xuesheng` == this.tableName && this.ruleForm.email&&(!this.$validate.isEmail(this.ruleForm.email))){
      ...
      if((!this.emailcode) && `xuesheng` == this.tableName){
