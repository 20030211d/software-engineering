    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="消费记录" prop="xiaofeijilu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="消费记录"
                  v-model="ruleForm.xiaofeijilu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiaofeijilu" label="消费记录" prop="xiaofeijilu">
                    <span>{{ruleForm.xiaofeijilu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.xiaofeishijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiaofeijine = true;
          ...
          if(o=='xiaofeijilu'){
            this.ruleForm.xiaofeijilu = obj[o];
	    this.ro.xiaofeijilu = true;
            continue;
          }
          if(o=='xiaofeishijian'){
