<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="校园卡号" prop="xiaoyuankahao">
          <el-input v-model="ruleForm.xiaoyuankahao" 
              placeholder="校园卡号" clearable  :readonly="ro.xiaoyuankahao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="校园卡号" prop="xiaoyuankahao">
              <el-input v-model="ruleForm.xiaoyuankahao" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="注销时间" prop="zhuxiaoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zhuxiaoshijian" 
                type="datetime"
                :readonly="ro.zhuxiaoshijian"
                placeholder="注销时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhuxiaoshijian" label="注销时间" prop="zhuxiaoshijian">
              <el-input v-model="ruleForm.zhuxiaoshijian" 
                placeholder="注销时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.zhuxiaoshijian = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiaoyuankahao = true;
          ...
          if(o=='zhuxiaoshijian'){
            this.ruleForm.zhuxiaoshijian = obj[o];
	    this.ro.zhuxiaoshijian = true;
            continue;
          }
          if(o=='beizhu'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xiaoyuankazhuxiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xiaoyuankazhuxiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
