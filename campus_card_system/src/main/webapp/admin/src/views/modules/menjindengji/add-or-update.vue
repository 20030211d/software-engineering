<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="校门" prop="xiaomen">
          <el-select :disabled="ro.xiaomen" v-model="ruleForm.xiaomen" placeholder="请选择校门">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="校门" prop="xiaomen">
	      <el-input v-model="ruleForm.xiaomen"
                placeholder="校门" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='xiaomen'){
            this.ruleForm.xiaomen = obj[o];
	    this.ro.xiaomen = true;
            continue;
          }
          if(o=='leixing'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `menjindengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.menjindengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
